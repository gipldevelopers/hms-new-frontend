    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          style={{ minWidth }}
        >
          <span className="truncate text-muted-foreground">{selected ? selected.label : placeholder}</span>
      ...
      <div className="bg-card border border-border p-4 rounded-lg flex flex-col sm:flex-row justify-between items-center gap-4 shadow-none">
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div className="flex flex-col">
             ...
             <h1 className="text-[18px] font-bold text-foreground leading-none mt-1">Add Progress Note</h1>
          </div>
        </div>
