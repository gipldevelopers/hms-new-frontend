    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          style={{ minWidth }}
        >
          <span className="truncate text-[#5E6C84]">{selected ? selected.label : placeholder}</span>
      ...
      <div className="bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 p-4 rounded-[5px] flex flex-col sm:flex-row justify-between items-center gap-4 shadow-none">
        <div className="flex items-center gap-4 w-full sm:w-auto">
          ...
          <div className="flex flex-col">
             ...
             <h1 className="text-[18px] font-bold text-[#1A1C23] dark:text-white leading-none mt-1">Add Progress Note</h1>
          </div>
        </div>
