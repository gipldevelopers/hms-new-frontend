    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-[#111827] w-full max-w-[440px] rounded-[5px] border border-border overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-8 flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-[18px] font-bold text-[#1A1C23] dark:text-white">Registration Successful</h2>
            <p className="text-[13px] text-[#5E6C84] dark:text-slate-400 max-w-[300px] mx-auto leading-relaxed">
              The patient has been successfully registered in the Emergency Ward.
            </p>
          </div>
...
export default function QuickEmergencyRegistration() {
  ...
  const handleSubmit = async (isDraft = false) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/emergency`, {
        method: "POST",
        headers: {
      ...
      if (isDraft) {
        router.push("/super-admin/emergency-registration");
      } else {
    ...
    <div className="flex flex-col gap-5 p-5 min-h-screen bg-background">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <button
            onClick={() => router.push("/super-admin/emergency-registration")}
