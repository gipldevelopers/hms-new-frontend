    ...
    <div className="p-4 md:p-6 bg-background min-h-screen flex flex-col space-y-[15px] md:space-y-[20px] transition-colors duration-300 font-sans pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap">
          ...
          <button
            onClick={() => router.push(`/super-admin/patient-detail/vitals/${patientId}/entry?from=vitals`)}
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex gap-1">
                  <button
                    onClick={() => router.push(`/super-admin/patient-detail/vitals/${patientId}/entry?mode=edit&entryId=${v.id}&from=vitals`)}
                    className="p-2 hover:bg-muted rounded-lg transition-colors"
                  >
                    <Pencil className="w-4 h-4 text-muted-foreground" />
                  </button>
                  <button
                    onClick={() => router.push(`/super-admin/patient-detail/vitals/${patientId}/entry?mode=view&entryId=${v.id}&from=vitals`)}
                    className="p-2 hover:bg-muted rounded-lg transition-colors"
                  >
