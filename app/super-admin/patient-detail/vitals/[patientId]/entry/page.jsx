...
function VitalsEntryContent() {
  ...
  const destPath = from === "patient"
    ? `/super-admin/patient-detail/patients/${patientId}?tab=Vitals`
    : `/super-admin/patient-detail/vitals/${patientId}`;
  ...
  const SidebarContent = () => (
    <div className="space-y-5">
      ...
      <div className="bg-card rounded-lg border border-border p-5">
        ...
        <button
          onClick={() => router.push(`/super-admin/patient-detail/vitals/${patientId}`)}
