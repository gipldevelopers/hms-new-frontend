    ...
    <div className="p-4 md:p-6 bg-background min-h-screen flex flex-col space-y-[15px] md:space-y-[20px] transition-colors duration-300 font-sans pb-20">
      ...
      <div className="bg-card p-4 md:p-6 rounded-lg border border-border shadow-none">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 md:gap-8">
          {/* Avatar Section */}
          <div className="w-[70px] h-[70px] md:w-[100px] md:h-[100px] rounded-full overflow-hidden border-2 border-border shrink-0 shadow-none">
             <img 
          ...
          <div className="flex-1 space-y-4 md:space-y-6 w-full">
            ...
            <div className="flex flex-col xs:flex-row items-center justify-between gap-3">
              <div className="flex flex-col xs:flex-row items-center gap-2 md:gap-4 text-center xs:text-left">
                <h2 className="text-[18px] md:text-[22px] font-bold text-foreground leading-none tracking-tight">James Wilson</h2>
                <span className="text-[12px] md:text-[13px] font-medium text-muted-foreground leading-none">62 yrs • Male</span>
              </div>
              <span className="px-3 py-1 rounded-full bg-destructive/10 border border-destructive/20 text-destructive text-[9px] font-black uppercase tracking-widest">CRITICAL</span>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-y-5 gap-x-4 md:gap-8">
              <div>
                ...
                <p className="text-[12px] md:text-[14px] font-bold text-foreground">UHID-839211</p>
              </div>
              <div>
                <p className="text-[8px] md:text-[9px] font-bold text-muted-foreground mb-1 uppercase tracking-widest">BED NO.</p>
                <p className="text-[12px] md:text-[14px] font-bold text-foreground">ICU-04</p>
              </div>
              <div>
                <p className="text-[8px] md:text-[9px] font-bold text-muted-foreground mb-1 uppercase tracking-widest">ADMISSION DATE</p>
                <p className="text-[12px] md:text-[14px] font-bold text-foreground">12 Oct 2023</p>
              </div>
              <div className="hidden xs:block">
                <p className="text-[8px] md:text-[9px] font-bold text-muted-foreground mb-1 uppercase tracking-widest">ATTENDING</p>
                <p className="text-[12px] md:text-[14px] font-bold text-foreground leading-tight">Dr. Sarah Jenkins</p>
              </div>
              <div className="col-span-2 xs:col-span-1 lg:pl-8 lg:border-l lg:border-border pt-4 xs:pt-0 border-t xs:border-t-0 border-border">
                <p className="text-[8px] md:text-[9px] font-bold text-muted-foreground mb-1 uppercase tracking-widest">DIAGNOSIS</p>
                <p className="text-[12px] md:text-[14px] font-bold text-foreground leading-tight">Acute Myocardial Infarction</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4">
        ...
        {activeTab === "Summary" && (
          <button className="bg-primary text-primary-foreground px-6 h-[44px] rounded-lg text-[13px] font-bold flex items-center justify-center gap-2 hover:bg-primary/90 transition-all shadow-none shrink-0 w-full lg:w-auto">
            <Plus className="w-4 h-4" />
            Add Vitals
          </button>
        )}
