  ...
  return (
    <div className="p-4 md:p-6 bg-[#F8F9FC] dark:bg-[#0A0F1D] min-h-screen flex flex-col space-y-[20px] transition-colors duration-300 font-sans pb-20 select-none">
      ...
      <div className="flex items-center">
        <button
          onClick={() => router.back()}
          className="p-2 hover:bg-muted rounded-[5px] border border-transparent flex items-center gap-2 text-foreground font-bold text-[13px] shadow-none select-none transition-all"
        >
      ...
      <div className="bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 p-5 rounded-[5px] flex flex-col md:flex-row items-center gap-5 shadow-none select-none">
        <div className="flex items-center gap-4 shrink-0 w-full md:w-auto">
          <img
            src="https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=100&auto=format&fit=crop&q=60"
            alt="Patient"
            className="w-16 h-16 rounded-full border border-[#E7E8EB] dark:border-white/10 object-cover shrink-0 select-none"
          />
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="bg-red-500/10 text-red-600 dark:text-red-400 border border-red-500/20 font-bold text-[10px] px-2 py-0.5 rounded-[5px] leading-tight select-none">
                CRITICAL
              </span>
            </div>
      ...
      <div className="bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 p-5 rounded-[5px] flex flex-col md:flex-row justify-between md:items-center gap-4 shadow-none select-none">
        <div>
        ...
        <div className="flex items-center gap-3">
          <span className={cn(
            "rounded-[5px] font-bold px-3 py-1 text-[11px] select-none tracking-wide",
          ...
          <span className={cn(
            "rounded-[5px] font-bold px-3 py-1 text-[11px] select-none tracking-wide flex items-center gap-1.5",
      ...
      <div className="bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 p-5 rounded-[5px] flex flex-col space-y-5 shadow-none select-none">
        <div>
      ...
      {/* ── Action Buttons ── */}
      <div className="flex justify-end items-center gap-3 select-none">
        <button
          onClick={() => alert(`Contacting ${service.dept} department...`)}
          className="h-11 px-5 border border-primary hover:bg-primary/5 text-primary rounded-[5px] text-[13px] font-bold flex items-center justify-center gap-2 transition-all shadow-none outline-none select-none bg-white dark:bg-[#101935]"
        >
          <MessageSquare className="w-4 h-4" /> Contact Department
        </button>
        <button
          onClick={() => alert("Re-request submitted successfully!")}
          className="h-11 px-6 bg-primary hover:bg-primary/90 text-white rounded-[5px] text-[13px] font-bold flex items-center justify-center gap-2 transition-all shadow-none outline-none select-none"
        >
