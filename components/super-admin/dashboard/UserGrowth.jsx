  ...
  return (
    <div className="bg-white dark:bg-[#101935] rounded-[5px] border border-[#E7E8EB] dark:border-white/10 overflow-hidden font-sans transition-all">
      ...
      <div className="flex justify-between items-center px-6 py-4 border-b border-[#E7E8EB] dark:border-white/10">
        <h3 className="text-[16px] font-bold text-[#101935] dark:text-white">User Growth</h3>
      ...
      <div className="p-6 h-[300px] relative flex">
        {/* Y-Axis Labels */}
        <div className="flex flex-col justify-between text-[11px] font-medium text-[#64748B] dark:text-slate-500 pr-4 pb-10">
          {yLabels.map((label) => (
        ...
        <div className="relative flex-1 h-full">
          ...
          >
            {/* Smooth Curve Path tuned to match the screenshot */}
            <path
              d="M 0,140 
                 C 50,140 80,125 125,120 
                 S 175,90 225,95 
                 S 275,180 325,180 
                 S 375,140 425,140 
                 S 475,30 500,30"
          ...
          {/* X-Axis Labels */}
          <div className="absolute bottom-0 w-full flex justify-between text-[12px] text-[#64748B] dark:text-slate-500 font-medium px-1">
            {xLabels.map((month) => (
