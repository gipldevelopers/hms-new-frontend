...
export default function CreatePurchaseRequest({ onBack }) {
  ...
  const [requestedBy, setRequestedBy] = useState("Jane Smith (Technician)");
      ...
      <div className="flex justify-between items-center mb-6 bg-white dark:bg-[#1e293b] p-4 rounded-[5px] border border-[#e2e8f0] dark:border-[#334155]">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[12px] text-slate-505 dark:text-slate-400 font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div className="lg:col-span-4 bg-white dark:bg-[#1e293b] p-5 rounded-[5px] border border-[#e2e8f0] dark:border-[#334155] flex flex-col gap-5 shadow-none h-full">
            ...
            <div className="space-y-1.5">
              <label className="text-[12px] font-bold text-slate-700 dark:text-slate-305">
                Requesting Department *
              </label>
            ...
            <div className="space-y-2">
              <label className="text-[12px] font-bold text-slate-700 dark:text-slate-355">
                Priority Level *
              </label>
          ...
          <div className="lg:col-span-8 space-y-6">
                        ...
                        <tr key={item.id} className="align-middle">
                          <td className="py-3 pr-2 max-w-[200px]">
                            <input
                              ...
                              className="font-bold text-[13px] text-slate-800 dark:text-white bg-transparent border-b border-transparent hover:border-slate-355 focus:border-[#2E37A4] outline-none w-full"
                            />
                            <input
                              type="text"
                              value={item.sku}
                          ...
                          <td className="py-3 text-center px-2 font-bold text-red-505 dark:text-red-404">
                            {item.current}
                          </td>
                          ...
                          <td className="py-3 px-2">
                            <input
                              ...
                              className="font-medium text-slate-606 dark:text-slate-300 bg-transparent border-b border-transparent hover:border-slate-300 focus:border-[#2E37A4] outline-none w-full"
                            />
                          </td>
                          <td className="py-3 text-center px-2">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white dark:bg-[#1e293b] p-4 rounded-[5px] border border-[#e2e8f0] dark:border-[#334155]">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[12.5px] font-bold text-slate-700 dark:text-slate-305">
