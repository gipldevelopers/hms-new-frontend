...
export function InventoryTable({ items, setItems, onViewItem, triggerAddModal, clearAddTrigger, triggerEditModal, clearEditTrigger, hideTableContent, onRefresh, onAddClick, editModalTitle }) {
  ...
  const handleExportExcel = () => {
    try {
      ...
      link.setAttribute("download", `Lab_Inventory_${new Date().toISOString().slice(0, 10)}.csv`);
      ...
      toast.error("Failed to export lab inventory.");
    }
  };
        ...
        <>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 ">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <button
                onClick={onAddClick || (() => setModalType("add"))}
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className={cn(
                    "h-10 px-4 rounded-[5px] text-[13px] font-semibold flex items-center gap-2 hover:bg-muted transition-all outline-none border cursor-pointer",
