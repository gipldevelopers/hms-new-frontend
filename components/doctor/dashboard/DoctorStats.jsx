...
export default function DoctorStats({ stats, loading }) {
  const displayStats = [
    { 
      label: "Total Patients", 
      value: loading ? "—" : stats?.totalPatients !== undefined ? String(stats.totalPatients) : "0", 
      change: "+95%", 
      trend: "up", 
      icon: User, 
      color: "text-sky-500", 
    ...
    { 
      label: "OPD Visits", 
      value: loading ? "—" : stats?.opdVisits !== undefined ? String(stats.opdVisits) : "0", 
      change: "+25%", 
      trend: "up", 
      icon: Stethoscope, 
      color: "text-rose-500", 
    ...
    { 
      label: "IPD Admission", 
      value: loading ? "—" : stats?.ipdAdmissions !== undefined ? String(stats.ipdAdmissions) : "0", 
      change: "-15%", 
      trend: "down", 
      icon: Building2, 
      color: "text-blue-500", 
    ...
    { 
      label: "Emergency", 
      value: loading ? "—" : stats?.emergency !== undefined ? String(stats.emergency) : "0", 
      change: "+25%", 
      trend: "up", 
      icon: Siren, 
