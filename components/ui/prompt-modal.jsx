        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full h-12 px-4 bg-[#F8F9FC] dark:bg-[#1e293b] border border-[#E7E8EB] dark:border-white/10 rounded-[5px] text-[14px] font-semibold focus:ring-1 focus:ring-primary outline-none placeholder:text-gray-300 transition-all"
              value={value}
          ...
          <div className="flex gap-3 pt-4">
            <button 
              type="button"
              onClick={onClose}
              className="flex-1 h-12 text-[13px] font-bold text-gray-500 bg-gray-50 dark:bg-white/5 hover:bg-gray-100 rounded-[5px] transition-all"
            >
              Cancel
            </button>
            <button 
              type="submit"
              className="flex-1 h-12 text-[13px] font-bold text-white bg-primary hover:opacity-90 rounded-[5px] transition-all shadow-lg shadow-primary/10"
            >
              {confirmText}
            </button>
          </div>
