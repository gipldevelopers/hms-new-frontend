...
export default function CreatePurchaseRequest({ onBack }) {
  ...
  const [requestedBy, setRequestedBy] = useState("John Doe (Receptionist)");
                    ...
                    {items.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className="align-middle">
                          ...
                          <td className="py-3 text-right pl-2 font-bold text-[13px] text-slate-800 dark:text-white">
