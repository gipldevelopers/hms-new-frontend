...
export function PatientBillingDetailsMain({ searchParams }) {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto space-y-6 font-inter">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2 text-[13px] font-medium text-gray-500 dark:text-gray-400">
          ...
          <span className="hover:text-[#2E37A4] transition-colors cursor-pointer">
            {type.toUpperCase() === "IPD" ? "IP Running Bills" : "OPD Running Bills"}
          </span>
          <ChevronRight className="w-3.5 h-3.5" />
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/finance/patient-billing/create" className="h-10 px-4 bg-white hover:bg-gray-50 dark:bg-white/5 border border-[#CBD5E1] dark:border-white/10 text-[#1e293b] dark:text-white font-bold rounded-[6px] text-[13px] transition-all cursor-pointer flex items-center justify-center">
              + Add Charge
            </Link>
      ...
      <div className="bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 rounded-[8px] p-6 shadow-sm">
...
function BillingChargesSection() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 bg-white dark:bg-[#101935] border border-[#E7E8EB] dark:border-white/10 rounded-[8px] pt-6 pb-0 px-0 font-inter h-fit shadow-sm">
        {/* Title */}
      ...
      <div className="lg:col-span-4 bg-white dark:bg-[#101935] border border-[#E2E8F0] dark:border-white/10 rounded-[8px] pt-6 pb-6 px-0 h-fit font-inter">
        {/* Title */}
        <h2 className="text-[18px] font-bold text-[#1e293b] dark:text-white mb-5 px-6">Gross Total</h2>
