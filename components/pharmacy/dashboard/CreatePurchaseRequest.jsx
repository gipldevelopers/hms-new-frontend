...
export default function CreatePurchaseRequest({ onBack }) {
  ...
  const [department, setDepartment] = useState("Central Pharmacy");
  const [requestedBy, setRequestedBy] = useState("Sarah Alvi (Store Manager)");
              ...
              <div className="space-y-2">
                ...
                >
                  <input
                    ...
                    className="mt-1 h-3.5 w-3.5 text-amber-600 border-amber-300 focus:ring-amber-505"
                  />
                  <div className="-mt-0.5">
                ...
                >
                  <input
                    ...
                    className="mt-1 h-3.5 w-3.5 text-blue-600 border-blue-300 focus:ring-blue-500"
                  />
                  <div className="-mt-0.5">
                        ...
                        <tr key={item.id} className="align-middle">
                          <td className="py-3 pr-2 max-w-[200px]">
                            <input
                              ...
                              className="font-bold text-[13px] text-slate-800 dark:text-white bg-transparent border-b border-transparent hover:border-slate-305 focus:border-[#2E37A4] outline-none w-full"
                            />
                            <input
                              type="text"
                              value={item.sku}
                          ...
                          <td className="py-3 px-2">
                            <input
                              ...
                              className="font-medium text-slate-600 dark:text-slate-300 bg-transparent border-b border-transparent hover:border-slate-300 focus:border-[#2E37A4] outline-none w-full"
                            />
                          </td>
                          <td className="py-3 text-center px-2">
            ...
            <div className="bg-white dark:bg-[#1e293b] p-5 rounded-[5px] border border-[#e2e8f0] dark:border-[#334155] space-y-4 shadow-none">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-2">
                ...
                <div className="flex-1 w-full sm:w-auto flex flex-col items-center justify-center p-3 rounded-[5px] border border-[#e2e8f0] dark:border-[#334155] bg-white dark:bg-[#0A0F1D] text-center">
                  ...
                  <span className="text-[10px] text-slate-455 dark:text-slate-555 font-extrabold tracking-wide uppercase mt-1">
                    Pharmacist Review
                  </span>
                </div>
